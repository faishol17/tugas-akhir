    ...
    <div class="mx-auto lg:px-16 md:px-20 px-8 py-8 ">
        <div class="sm:flex sm:mt-16">
            <div class="mt-8 sm:mt-0 sm:w-full flex flex-col md:flex-row justify-between">
                <div class="flex-1 mt-2 flex-col ml-5">
                    <h2 class="font-medium text-white text-lg mb-4">Tentang Kami</h2>
                    <div class="my-3">
                        <p class="text-serv-text font-light">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p> 
                    </div>
                </div>
                <div class="flex-1 mt-2 flex-col mr-5">
                    <h4 class="font-medium text-white text-lg mt-4 md:mt-0 mb-4">Layanan Kami</h4>
                    <div class="my-3">
                ...
                <div class="flex-1 mt-2 flex-col">
                    <h4 class="font-medium text-white text-lg mt-4 md:mt-0 mb-4">Kontak</h4>
                    <div class="my-3">
                        <a href="#" class="text-serv-text font-light">
                            Instagram
                        </a>
        ...
        <div class="sm:flex sm:mt-16">
            <div class="mt-8 sm:mt-0 sm:w-full flex flex-col md:flex-row justify-between">
                <div class="flex-1 mt-2 flex-col">
                    ...
                    <div class="my-3">
                        <p class="text-serv-text font-light text-lg leading-relaxed text-serv-text font-light tracking-wide mb-10 lg:mb-18">
                          jl. lohbener lama No.08, Legok, Kec. Lohbener, 
                ...
                <div class="flex-1 mt-2 flex-col lg:mr-28">
                    <h4 class="font-medium text-white text-lg mt-4 md:mt-0 mb-4">Tentang Kami</h4>
                    <div class="my-3">
                        <p class="text-serv-text font-light">
