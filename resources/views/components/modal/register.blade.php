            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="relative p-6 flex-auto mx-10">
                    <div class="mb-4">
                        ...
                        <input name="name" class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs" id="name" type="text" placeholder="Nama" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input name="email" class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs" id="email" type="email" placeholder="Email" required>
                    ...
                    <div>
                        ...
                        <input name="password" class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs mb-3" id="password" type="password" placeholder="Password" required>
                    ...
                    <div>
                        ...
                        <input name="password_confirmation" class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs mb-3" id="password_confirmation" type="password" placeholder="Ulangi Password" required>
                ...
                <div class="px-6 pb-6 rounded-b-xl mx-10">
                    ...
                    <p href="#" class="text-center py-5">
                        Udah Punya Akun? <a href="#" class="text-serv-button" onclick="toggleModal('loginModal');toggleModal('registerModal') ">Masuk</a>
                    </p>
                </div>
            </form>
