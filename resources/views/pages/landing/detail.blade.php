                ...
                <div class="content">
                    <div x-data="{ tab: window.location.hash ? window.location.hash.substring(1) : 'description' }" id="tab_wrapper">
                        ...
                        <nav class="my-8" aria-label="navigation">
                                <a class="inline-block px-8 py-2 my-2 mr-2 font-medium rounded-xl" :class="{ 'bg-serv-bg text-white': tab === 'description','bg-serv-services-bg text-serv-bg' : tab !== 'description' }" @click.prevent="tab = 'description'; window.location.hash = 'description'" href="#">Deskripsi</a>
                                <a class="inline-block px-8 py-2 my-2 mr-2 font-medium rounded-xl" :class="{ 'bg-serv-bg text-white': tab === 'seller' ,'bg-serv-services-bg text-serv-bg' : tab !== 'seller' }" @click.prevent="tab = 'seller'; window.location.hash = 'seller'" href="#">Tentang Seller</a>
                        ...
                        <div x-show.transition.duration.500ms="tab === 'description'" class="leading-8 text-md">
                            <h2 class="text-xl font-semibold">Deskripsi <span class="text-serv-button">Services</span></h2>
                            <div class="mt-4 mb-8 content-description">
                                <p>
                                    {{ $service->description ?? '' }}
                                </p>
                            </div>
                            <h3 class="my-4 text-lg font-semibold">Keungulan Service</h3>
                        ...
                        <div x-show.transition.duration.500ms="tab === 'seller'" class="leading-8 text-md">
                            <h2 class="mb-4 text-xl font-semibold">Tentang <span class="text-serv-button">Freelencer</span></h2>
                            ...
                            <h3 class="my-4 text-lg font-semibold">Penggalaman</h3>
                            ...
                            <p class="my-4 text-lg text-gray-400">
                                Bergabung Pada {{ date("d F Y",strtotime($service->created_at)) ?? '' }}
                            </p>
                        </div>
                ...
                <div class="mb-4 border rounded-lg border-serv-testimonial-border">
                    ...
                    <div class="px-4 pb-4 booking">
                        ...
                        @guest
                            ...
                            <br>
                            <a onclick="toggleModal('loginModal')" class="block px-12 py-4 my-2 text-lg font-semibold text-center text-white bg-serv1-button rounded-xl">
                                Hubungi
                            </a>
                        @endguest
                    </div>
