            ...
            <div class="mx-auto flex pt-16 pb-16 lg:pb-20 lg:px-24 md:px-16 sm:px-8 px-8 lg:flex-row flex-col">
                ...
                <div
                    ...
                    <h1
                        ...
                        Selesaikan Proyek Anda Dengan<br class="lg:block hidden">
                        Freelancer Terbaik Kami 
                    </h1>
                    <p class="text-lg leading-relaxed text-serv-text font-light tracking-wide mb-10 lg:mb-18 ">
                        Temukan ribuan pekerja jarak jauh yang terbaik<br class="lg:block hidden">
                        keterampilan dan pengalaman untuk membantu Anda mencapai<br class="lg:block hidden">
                        proyek Anda.
                    </p>
                    <div
