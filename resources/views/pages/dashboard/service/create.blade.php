    ...
    <main class="h-full overflow-y-auto">
        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                ...
                <li class="flex items-center">
                    <p class="font-medium">Tambah Service</p>
                </li>
            </ol>
        </nav>
                            ...
                            <div class="">
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            <label for="thumbnail-service" class="block mb-3 font-medium text-gray-700 text-md">Gambar</label>
                                        ...
                                        <div class="col-span-6">
                                            <label for="advantage-user" class="block mb-3 font-medium text-gray-700 text-md">Pengalaman Kamu</label>
                                        ...
                                        <div class="col-span-6">
                                            <label for="service-name" class="block mb-3 font-medium text-gray-700 text-md">Skill <span class="text-gray-400">(Optional)</span></label>
