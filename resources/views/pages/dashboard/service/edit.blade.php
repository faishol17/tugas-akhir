...
<main class="h-full overflow-y-auto">
    ...
    <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
        <ol class="inline-flex p-0 list-none">
            ...
            <li class="flex items-center">
                <a href="#" class="font-medium">Edit Service</a>
            </li>
        </ol>
    </nav>
                            ...
                            <div class="px-4 py-5 sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input placeholder="Butuh Berapa Hari Service Kamu Selesai?" type="text" name="delivery_time" id="delivery_time" autocomplete="delivery_time" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('delivery_time') }}" required>
                                    </div>
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input placeholder="Maksimal Revisi service kamu?" type="text" name="revision_limit" id="revision_limit" autocomplete="revision_limit" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('revision_limit') }}" required>
                                    </div>
                                    ...
                                    <div class="col-span-6">
                                        <label for="advantage-users" class="block mb-3 font-medium text-gray-700 text-md">Pengalaman kamu</label>
                                    ...
                                    <div class="col-span-6">
                                        <label for="taglines" class="block mb-3 font-medium text-gray-700 text-md">Skill <span class="text-gray-400">(Optional)</span></label>
                                        <div id="newTaglineRow"></div>

                                        @forelse ($tagline as $tagline_item)
                                            <input placeholder="Skill" type="text" name="{{ ('taglines['.$tagline_item->id.']') }}" id="taglines" autocomplete="taglines" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $tagline_item->tagline ?? '' }}" required>
                                        @empty
                                            {{-- empty --}}
                                        @endforelse
...
@push('after-script')
    ...
    <script type="text/javascript">
        ...
        $("#addTaglineRow").click(function() {
            var html = '';
            html += '<input placeholder="Skill" type="text" name="tagline[]" id="tagline" autocomplete="tagline" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>';
